...
public class DlgModificationHexagon extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public DlgModificationHexagon(Model model) {
		setModal(true);
		setTitle("Modification hexagon");
	...
	public HexagonAdapter getDataH() {
		Hexagon h = new Hexagon(x, y, radius);
		h.setAreaColor(colorArea);
		h.setBorderColor(colorEdge);
